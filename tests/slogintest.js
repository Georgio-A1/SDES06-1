...
(async function loginCorretoTest() {
    ...
    try {
        ...
        // Encontrando os campos de CPF e senha e insira as credenciais corretas
        ...
        // Aguardando o redirecionamento para o dashboard
        await driver.wait(until.urlContains('/dashboard'), 10000);

        // Verificando se a URL foi redirecionada corretamente para o dashboard
